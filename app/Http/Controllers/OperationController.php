        ...
        foreach ($guests as $guest) {
            ...
            if ($guest['whatsapp'] != null && $guest['whatsapp'] != "") {
                ...
                curl_setopt(
                    ...
                    CURLOPT_HTTPHEADER,
                    array(
                        'Authorization: Bearer EAAJNk9TfhxABOwYeZBaEMzSDd8ScLZCd2n7ZBSprrR1H1LojyJO1CBVYXNsEAQmyuC5yQZAE15FDw6H5BQEtG5KMnGWXZBQ6fnu8NP5cevCvb4vZCahtXCDvZCwC3sKOvjAGcZBhx2RZCm6pyk79jDhLvsqPIfYfiJAJCOfmbJpK8IFxAGFwV0Up0cX1S8VNrVj35qzwkZCYBieuFn6W70ZBPGEq3Tg',
                        'Content-Type: application/json'
                    )
                );
                curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
