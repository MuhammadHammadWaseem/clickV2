        ...
        foreach ($guests as $guest) {
            ...
            if ($guest['whatsapp'] != null && $guest['whatsapp'] != "") {
                ...
                curl_setopt(
                    ...
                    CURLOPT_HTTPHEADER,
                    array(
                        'Authorization: Bearer EAAJNk9TfhxABOyJZAdwno3UohLjPQfAxVXp6y9b4ZCtnd9VVyPzaRryMSXYYSTABPOXYahVXQoxY4a8vX9GWj2RkbH8tTLC605ZAbJ3x63xu6Bz3tvXmxWxJEd2spIpKcgpiwOdESoWZAga3VZCeKX5praY08hbpcA74YGm8uHJjMy7fcCUdhyHAZD',
