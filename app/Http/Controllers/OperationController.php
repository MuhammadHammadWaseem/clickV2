        ...
        foreach ($guests as $guest) {
            ...
            if ($guest['whatsapp'] != null && $guest['whatsapp'] != "") {
                ...
                curl_setopt(
                    ...
                    CURLOPT_HTTPHEADER,
                    array(
                        'Authorization: Bearer EAAJNk9TfhxABO7H6Me2ZAGiKjSJwzp1FUEZBcaGUdPceJR5MO02ZAs7eGvvI0Kwn69ihzeX3w2u6pwyZA07RUngEpHADyLHPxnt4j9ZBCG5vPhCUpqeyZAkqzzxDpyZBZCJ8VybVj3COXGtNe2JpLIZCertdfZCj4pc7WPmuZC4FsolfZBDReoosE0Oax3hBAS09f4ftEAFM5dFTDxa1AhE9ZATPanBKe',
                        'Content-Type: application/json'
                    )
                );
                curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
