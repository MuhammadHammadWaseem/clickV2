...
class OperationController extends Controller
{
    ...
    public function sendWhatsapp(Request $req)
    {
        ...
        if (strlen($guest->whatsapp) > 0) {
            ...
            curl_setopt($curl, CURLOPT_HTTPHEADER, array('Authorization:Bearer EAAJNk9TfhxABO9ATWhlUEJW2K7E3wjUFi8dje0hF5CAYQxwda1m4Drla5jPIQGXMpwstcDsn5ngvC90c1gd5v0qPa07TL4qTSOQsoIDcOh9dB4kytUnuh1IvedLF5NZAHASUaXw4ePBojFOFjGZB52vUe4lYdhxHnmQNtn9phYoq3XmbEKqa4ZD', 'Content-Type: application/json'));
        ...
        foreach ($guests as $guest) {
            ...
            if ($guest['whatsapp'] != null && $guest['whatsapp'] != "") {
                ...
                curl_setopt(
                    ...
                    CURLOPT_HTTPHEADER,
                    array(
                        'Authorization: Bearer EAAJNk9TfhxABO9ATWhlUEJW2K7E3wjUFi8dje0hF5CAYQxwda1m4Drla5jPIQGXMpwstcDsn5ngvC90c1gd5v0qPa07TL4qTSOQsoIDcOh9dB4kytUnuh1IvedLF5NZAHASUaXw4ePBojFOFjGZB52vUe4lYdhxHnmQNtn9phYoq3XmbEKqa4ZD',
