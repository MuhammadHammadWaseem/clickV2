...
@section('scripts')
    <script>
        ...
        // Function to update the displayed guests
        function updateGuestList(currentFilter) {
            console.log("currentGuests", currentGuests);
            var startIndex = (currentPage - 1) * guestsPerPage;
            var endIndex = startIndex + guestsPerPage;
            var guestsToShow = currentGuests.slice(startIndex, endIndex);

            $('#GuestList').empty();

            console.log("currentFilter: " + currentFilter);
            console.log("guestsToShow: " + guestsToShow.length);
        ...
        function updatePagination() {
            var totalPages = Math.ceil(currentGuests.length / guestsPerPage);
        ...
        // Function to handle page changes (previous or next)
        ...
        function showGuest(filter) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#totalinvite').html(
                        `<i class="fa fa-user" aria-hidden="true"></i> INVITED GUEST ${totalGuests}`);
                    $('#inviteMembers').html(
                        `<i class="fa fa-users" aria-hidden="true"></i> INVITED MEMBERS ${totalMembers}`);
