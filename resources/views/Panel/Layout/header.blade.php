                   ...
                   <div class="two_boxex_align">
                    <div class="langauge-person">
                        <div class="language-box">
                            <div class="nav-box">
                                <ul>
                                    <li class="drop-down-link"><a href="#"><img src="{{ asset('assets/Panel/images/translate-icon.png')}}" alt=""><i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                    <ul class="drop-menu">
                        ...
                        <div class="person-box">
                            <div class="nav-box">
                                <ul>
                                    <li class="drop-down-link" ><a href="#"><img src="{{ asset('assets/Panel/images/person-icon.png')}}" alt=""></a>
                                        <ul class="drop-menu">
                                            <li><a href="#">Events</a></li>
                                            <li><a href="#">Guest List</a></li>
                                            <li><a href="#">Contact Info</a></li>
