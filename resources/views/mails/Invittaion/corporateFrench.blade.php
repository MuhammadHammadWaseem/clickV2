                            ...
                            <tr>
                                <td align="center" valign="top">
                                    <table width="100%" cellpadding="0" bgcolor="#ffffff" cellspacing="0"
                                        style="background-color:#ffffff;border-radius:10px;border:1px solid #e8e8e8;border-collapse:separate;">
                                        <tbody>
                                            <tr>
                                                <td
                                                    style="background-color:#5a5a5a;text-align:center;padding:10px 15px;border-radius:10px 10px 0 0;">
                                            ...
                                            <tr>
                                                <td
                                                    style="padding:15px;font-family:'Open Sans',Helvetica,Arial;font-size:14px; text-align:center;">
                                                    ...
                                                    @if ($data['event']->type == 'CORPORATE')
                                                        <p style="font-style:italic;font-size:13px;text-align:center">
                                                            Tableau: {{ $data['guestTable']['name']?? '-' }} Siège:
                                                            {{ $data['guestTable']['guest_number']?? '-' }}
                                                        </p>
                                                        <br />
                                                    @endif
                                                    <p style="font-style:italic;font-size:13px;text-align:center">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <p style="font-weight:bold;margin:15px 5px 5px 5px">
                                                                        Réception</p>
                                                                    <p style="margin:5px">{{ $data['event']->recaddress }},
                                                                        {{ $data['event']->reccity }},
