...
<style>
    ...
    .letter {
        ...
        -webkit-transform: rotateX(90deg);
        -moz-transform: rotateX(90deg);
        @if($card[0]->customCard) background: url("{{ env('APP_URL') }}assets/images/cardAnimation/{{ $card[0]->cardName }}");

        @else background: url("http://clickadmin.searchmarketingservices.online/eventcards/{{ $card[0]->cardName }}");
